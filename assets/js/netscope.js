    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      switch (layertype) {
        ...
        case "interp":
          ...
          d.chOut = d.chIn; // unknown layer;  print error message;
          break;
        default:
